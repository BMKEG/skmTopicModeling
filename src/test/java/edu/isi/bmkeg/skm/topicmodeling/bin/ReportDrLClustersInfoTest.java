 ...
 *
 */
public class ReportDrLClustersInfoTest {
	...
	public void setUp() throws Exception {
		...
		clusterDocsFile = ctx.getResource("classpath:/edu/isi/bmkeg/skm/topicmodeling/clusterDocs.txt").getFile();
	...
	public void testToFile() throws Exception {
		...
		ReportDrLClustersInfo.main(args);
